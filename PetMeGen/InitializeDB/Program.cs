...
static void Main (string[] args)
{
        ...
        System.Console.WriteLine ("A new database called: PetMeGenNHibernate will be created (the previous information will be deleted).");
        System.Console.WriteLine ("-----------------------------------------------------------------------------");
        ...
        {
                if (ans.ToLower () == "y") {
                        CreateDB.Create ("PetMeGenNHibernate", "nhibernateUser", "nhibernatePass");
